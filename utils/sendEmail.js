...
const sendEmail = async (text) => {
  try {
    const info = await transporter.sendMail({
      ...
      to: 'vishal.kudtarkar@techsierra.in, fartrucking4@gmail.com, kaustubh@techsierra.in', // Recipients
      // to: 'vishal.kudtarkar@techsierra.in, kaustubh@techsierra.in', // Recipients
